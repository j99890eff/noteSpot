...
class SimpleInfoViewCell: UITableViewCell {
    ...
    var delegate : simpleCellDelegate! = nil
    ...
    @IBAction func clickMoreOption(sender: UIButton) {
    ...
    func UpdateUI(){
        ...
        if let Placeinfo = self.Place{
            ...
            if NSDate().timeIntervalSinceDate(Placeinfo.datetime) > 12*60*60 {
